      ...
      <div className="hidden lg:flex w-1/2 flex-col justify-center items-center rounded-[2.5rem] p-12 relative overflow-hidden bg-gradient-to-b from-white via-neutral-400 to-black">
        <div className="relative z-10 w-full max-w-md mx-auto flex flex-col items-center">
          ...
          <div className="w-full space-y-4 max-w-[340px]">
            {/* Step 1 */}
            <div className="flex items-center gap-4 bg-white text-black p-4 rounded-2xl shadow-xl">
              <div className="w-6 h-6 rounded-full bg-black text-white flex items-center justify-center text-xs font-bold shrink-0">
                1
              </div>
              <span className="font-semibold text-sm">Create up your account</span>
            </div>
            
            {/* Step 2 */}
            <div className="flex items-center gap-4 bg-[#1a1c22]/60 backdrop-blur-md text-gray-400 p-4 rounded-2xl border border-white/5">
              <div className="w-6 h-6 rounded-full bg-white/10 text-gray-300 flex items-center justify-center text-xs font-bold shrink-0">
                2
              </div>
              <span className="font-medium text-sm">Set up your profile</span>
            </div>
            ...
            <div className="flex items-center gap-4 bg-[#1a1c22]/60 backdrop-blur-md text-gray-400 p-4 rounded-2xl border border-white/5">
              ...
              <span className="font-medium text-sm">Watch the magic happen</span>
            </div>
          </div>
        </div>
